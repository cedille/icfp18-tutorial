...
\normalsize
      ...
      \item[$\myb$] So far: Functorial, IR, II
      \end{itemize}
      \end{beamercolorbox}
\end{minipage}};
\end{tikzpicture}
...
{
  \Huge
  $\vdash \textit{\textcolor{red}{C}e\textcolor{red}{D}il\textcolor{red}{LE}}$
}
...
\textcolor{red}{Syntax and semantics of Cedille}
\end{center}
\end{frame}
...
\pause
  ...
  {\color{purple}
    \large
    \fbox{Kleene trick: true equations can be assigned to any term}}

\vspace{-3.5cm}

\hspace{2.2cm}  \begin{tikzpicture}
  \draw[->,very thick,purple] (3.5,-2.1) -- (-0.77,.7);
  \end{tikzpicture}
